...
<header class="sticky">
  ...
  <a href="https://admin.dk.games/panel/" target="_blank" role="button">DK Control Panel</a>
</header>
<div class="container">
<?php
    /*
    ...
    */
    ...
    $url = "https://api.dk.games/v2/createSession?apikey=$apikey&userid=$userId&game=$gameId&mode=$mode";
